...
export function Top3Podium({ leaderboardData }: Top3PodiumProps) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="w-16 h-16 rounded-full bg-gradient-to-br from-gray-300 to-gray-400 mx-auto mb-3 flex items-center justify-center text-white text-xl font-bold">
      ...
      >
        ...
        <div className="w-20 h-20 rounded-full bg-gradient-to-br from-yellow-400 to-orange-500 mx-auto mb-3 flex items-center justify-center text-white text-2xl font-bold">
      ...
      <motion.div
        ...
        className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm text-center pt-12"
      >
        <div className="w-16 h-16 rounded-full bg-gradient-to-br from-orange-400 to-orange-600 mx-auto mb-3 flex items-center justify-center text-white text-xl font-bold">
